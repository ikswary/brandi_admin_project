...
from models.product_models import seller_list, first_category, get_attribute_group_id, second_category
...
def product_category(**kwargs):
    """상품 등록시 카테고리 정보 전달 API
        ...
        Returns:
             {data : first_category_list}, http status code
    ...
    try:
        ...
        return jsonify(data=first_category_list), 200
